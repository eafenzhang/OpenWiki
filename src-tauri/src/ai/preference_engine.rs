...
const CHINESE_STOP_WORDS: &[&str] = &[
    ...
    "可以", "能", "但", "但是", "而", "而且", "或", "或者", "如果", "因为", "所以",
    "虽然", "然后", "还", "又", "再", "已经", "正在", "将", "把", "被", "让", "给",
    "从", "向", "对", "于", "以", "为", "与", "及", "等", "中", "里", "外", "内",
    "前", "后", "左", "右", "大", "小", "多", "少", "长", "短", "高", "低", "新", "旧",
    "这个", "那个", "这些", "那些", "其他", "另外", "之", "其", "次", "第",
    "更", "最", "比", "非常", "十分", "特别", "相当", "越来越",
    "the", "a", "an", "is", "are", "was", "were", "be", "been", "being",
    "have", "has", "had", "do", "does", "did", "will", "would", "could", "should",
    "may", "might", "shall", "can", "need", "must", "ought", "dare",
...
pub fn update_preferences(
    ...
    if raw_text.is_empty() {
        log::info!("Content {} has no text, skipping preference update", content_id);
        return Ok(());
    }
...
fn extract_keywords(text: &str) -> Vec<String> {
    let stop_words: std::collections::HashSet<&str> =
        CHINESE_STOP_WORDS.iter().copied().collect();
